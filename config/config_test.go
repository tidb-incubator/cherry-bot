...
func TestLoadConfig(t *testing.T) {
	...
	assert.Equal(t, cfg.Repos["owner_1-repo_1"].MergeSIGControl, true, "skip test command field")
	assert.Equal(t, cfg.Repos["owner_2-repo_2"].MergeSIGControl, false, "skip test command field, default value")
	assert.Equal(t, cfg.Repos["owner_1-repo_1"].SkipTestCommand, true, "merge sig control field")
	assert.Equal(t, cfg.Repos["owner_2-repo_2"].SkipTestCommand, false, "merge sig control field, default value")
